...
window.open(url,name,'scrollbars=yes,resizable=yes, width=' + width + ',height='+height);
            ...
            <div id="content">
                ...
                <p>Here we have a teal window set up. These sell like hotcakes and are very popular. They can be completely customized to fit your taste.</p>
                <a href="javascript:newWin('/images/image8.jpg', 'Bigger Image', '500', '500')">
                <img src="/images/image8_200.jpg" alt="Teal Window">Click to enlarge</a>

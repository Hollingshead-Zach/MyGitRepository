...
window.open(url,name,'scrollbars=yes,resizable=yes, width=' + width + ',height='+height);
            ...
            <div id="content">
                <h1>Driftwood Sign</h1>
                <h2><i>Description:</i></h2>
                <p>Here we have a driftwood sign piece that can brighten up any room.</p>
                <a href="javascript:newWin('/images/image24.jpg', 'Bigger Image', '500', '500')">
                <img src="/images/image24_200.jpg" alt="Driftwood Sign">Click to enlarge</a><br>

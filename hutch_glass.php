...
window.open(url,name,'scrollbars=yes,resizable=yes, width=' + width + ',height='+height);
            ...
            <div id="content">
                ...
                <p>Here we have a hutch that is perfect for displaying your collections. No matter what you collect this can store it all.</p>
                <a href="javascript:newWin('/images/image6.jpg', 'Bigger Image', '500', '500')">
                <img src="/images/image6_200.jpg" alt="Hutch_glass">Click to enlarge</a>

...
window.open(url,name,'scrollbars=yes,resizable=yes, width=' + width + ',height='+height);
            ...
            <div id="content">
                ...
                <p>Here we have a corner table fit for a queen. It can be used to hold your lamp or even your favorite plant.</p>
                <a href="javascript:newWin('/images/image3.jpg', 'Bigger Image', '500', '500')">
                <img src="/images/image3_200.jpg" alt="Corner Table">Click to enlarge</a>

...
window.open(url,name,'scrollbars=yes,resizable=yes, width=' + width + ',height='+height);
            ...
            <div id="content">
                ...
                <p>Here we have a chalkboard that is perfect for keeping reminders close and style and fun even closer.</p>
                <a href="javascript:newWin('/images/image20.jpg', 'Bigger Image', '500', '500')">
                <img src="/images/image20_200.jpg" alt="Chalkboard">Click to enlarge</a>

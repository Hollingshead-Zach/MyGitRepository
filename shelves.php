...
window.open(url,name,'scrollbars=yes,resizable=yes, width=' + width + ',height='+height);
            ...
            <div id="content">
                ...
                <p>Here we have some shelves that give that perfect modern look with a shabby flare.</p>
                <a href="javascript:newWin('/images/image15.jpg', 'Bigger Image', '500', '500')">
                <img src="/images/image15_200.jpg" alt="Shelves">Click to enlarge</a>

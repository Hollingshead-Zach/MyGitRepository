...
window.open(url,name,'scrollbars=yes,resizable=yes, width=' + width + ',height='+height);
            ...
            <div id="content">
                ...
                <p>Here we have a hutch, perfect for showing off all your fun knick knacks and china. </p>
                <a href="javascript:newWin('/images/image4.jpg', 'Bigger Image', '500', '500')">
                <img src="/images/image4_200.jpg" alt="Hutch_1">Click to enlarge</a>

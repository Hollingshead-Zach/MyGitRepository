...
// Send the message
  $to = 'zachman2009@gmail.com';
  $from = "From: $email";
  $result = mail($to, $subject, $finalmessage, $from);
// Let the client know what happened
  if ($result == TRUE) {
    $reply = "Thank you $firstname for your interest in participating in the Prison to Prison Triathlon. We will contact you with further registration instruction.";
    unset($firstname);
    unset($lastname);
    unset($email);
    unset($subject);
    ...
    $reply = "Sorry $firstname but there was an error and the message could not be
sent.";
    unset($firstname);
    unset($lastname);
    unset($email);
